...
class TargetPrefix : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var i= Intent()
        btn_kB.setOnClickListener { i.putExtra("prefix","kiB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_MB.setOnClickListener { i.putExtra("prefix","MiB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_GB.setOnClickListener { i.putExtra("prefix","GiB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_TB.setOnClickListener { i.putExtra("prefix","TiB")
            setResult(RESULT_OK,i);  finish()
        }
