...
class InputPrefix : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var i= Intent()
        btn_kB.setOnClickListener { i.putExtra("prefix","kB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_MB.setOnClickListener { i.putExtra("prefix","MB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_GB.setOnClickListener { i.putExtra("prefix","GB")
            setResult(RESULT_OK,i);  finish()
        }
        btn_TB.setOnClickListener { i.putExtra("prefix","TB")
            setResult(RESULT_OK,i);  finish()
        }
    }
}